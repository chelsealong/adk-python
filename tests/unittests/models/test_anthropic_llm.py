...
def test_message_to_generate_content_response_sets_model_version():
  """message.model maps to LlmResponse.model_version."""
  from google.adk.models.anthropic_llm import message_to_generate_content_response
  ...
  assert response.model_version == "claude-sonnet-4-5-20250929"
...
async def test_streaming_sets_model_version():
  """event.message.model from message_start maps to the final model_version."""
  llm = AnthropicLlm(model="claude-sonnet-4-20250514")
  ...
  assert final_response.model_version == "claude-sonnet-4-5-20250929"
