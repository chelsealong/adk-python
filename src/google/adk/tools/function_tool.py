...
class FunctionTool(BaseTool):
  ...
  def _get_declaration(self) -> Optional[types.FunctionDeclaration]:
    # `ignore_params` drops the function context and input_stream (for
    # streaming tools), which the model doesn't understand. Return a copy:
    # the cached declaration is shared and callers (e.g. toolset prefixing)
    # mutate it.
